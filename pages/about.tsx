...
const About: NextPage = () => {
  ...
  return (
    <div>
      ...
      <p className="ml-40 mt-8 text-3xl font-medium">
      ...
      <p className={answerStyle}>
        ...
        it&rsquo;s very long and dense, so many students don&rsquo;t fully read
        it. Tree-styled graphs are optimal for quickly representing the
      ...
      <p className={answerStyle}>
        First find your course in the &quot;Courses&quot; page. Then, click the
        &quot;More Requirements&quot; button until the tree stops growing. This
        will show you every level of prereqs/coreqs required to take the course.
      </p>
      <p className={questionStyle}>
      ...
      <p className={answerStyle}>
        Right-click (or control-click if on Mac) on a course to pin its
        information popup on the screen. Left-click anywhere else on the map to
        unpin this popup.
      </p>
      <p className={questionStyle}>
      ...
      <p className={answerStyle}>
        We first plan on implementing a database where you can input the classes
        you&rsquo;ve completed. Then we can show you your progress towards
        diploma requirements and grey out the courses you can&rsquo;t take. We
        also want to implement a &quot;friend&quot; system where you can see the
        courses your friends are planning to take.
      </p>
      <p className={questionStyle}>Who made this website?</p>
      <p className={answerStyle}>
        The Exeter Course Map was designed and built by Michael Chen, Byran
        Huang, Nathan Khuu, and Eric Li from the Exeter Computing Club Project
        Group. We also want to thank Avaninder Bhaghayath for helping us fix our
        database.
      </p>
      <p className={questionStyle}>
      ...
      <p className="ml-44 mr-44 mt-3 mb-8 text-xl">
        ...
        <a href="mailto: nkhuu@exeter.edu" className="text-blue-600 underline ">
          (nkhuu@exeter.edu)
        </a>
        <span>
          . We&rsquo;re open to beginners, so don&rsquo;t be shy! Our only
          requirements are that you care about the project and can learn new
          things.
        </span>
      </p>
    </div>
